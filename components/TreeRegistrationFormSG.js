              ...
              <form className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      <input type="text" name="company" id="company" autoComplete="organization" value={company} placeholder="Trees for Hope" onChange={e => setCompany(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      <input type="text" name="dedication_for" id="dedication_for" autoComplete="organization" value={dedication_for} placeholder="Trees for Hope" onChange={e => setDedication_for(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    <label htmlFor="numbers_of_trees" className="block text-sm font-semibold leading-6 text-gray-900">
                      Numbers of Trees @ £10 / tree
                    </label>
                    <div className="mt-2.5">
                      <input type="text" name="numbers_of_trees" id="numbers_of_trees" autoComplete="organization" value={numbers_of_trees} placeholder="1" onChange={e => setNumbers_of_trees(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      <input type="file" name="images" id="images" autoComplete="organization" value={images} placeholder="1" onChange={e => setImages(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
