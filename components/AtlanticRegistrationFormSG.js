...
export default function AtlanticRegistrationFormSG() {
  ...
  const [dateplaceofbirth, setDateplaceofbirth] = useState("");
  ...
  const handleSubmit = async e => {
    ...
    const res = await fetch("/api/send", {
      ...
      body: JSON.stringify({
        lastname: lastname,
        firstname: firstname,
        dateplaceofbirth: dateplaceofbirth,
        email: email,
        phone: phone,
        kinphone: kinphone,
        reason: reason,
              ...
              <form className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="dateplaceofbirth" className="block text-sm font-semibold leading-6 text-gray-900">
                      Date and Place of Birth
                    </label>
                    <div className="mt-2.5">
                      <input type="dateplaceofbirth" name="dateplaceofbirth" id="dateplaceofbirth" autoComplete="dateplaceofbirth" value={dateplaceofbirth} onChange={e => setDateplaceofbirth(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      <textarea type="text" name="reason" id="reason" rows={4} autoComplete="organization" value={reason} placeholder="Trees for Hope" onChange={e => setReason(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      <textarea name="expectation" id="expectation" rows={4} value={expectation} onChange={e => setExpectation(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" defaultValue={""} />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    <label htmlFor="specialneed" className="block text-sm font-semibold leading-6 text-gray-900">
                      Do you have any special needs we should know about?
                    </label>
                    <div className="mt-2.5">
                      <textarea name="specialneed" id="specialneed" rows={4} value={specialneed} onChange={e => setSpecialneed(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" defaultValue={""} />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      <textarea name="dietary" id="dietary" rows={4} value={dietary} onChange={e => setDietary(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" defaultValue={""} />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    <label htmlFor="contribution" className="block text-sm font-semibold leading-6 text-gray-900">
                      Have you paid for the week? How much are you contributing?
                    </label>
                    <div className="mt-2.5">
                      <textarea name="contribution" id="contribution" rows={4} value={contribution} onChange={e => setContribution(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" defaultValue={""} />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    <label htmlFor="howdoyouhear" className="block text-sm font-semibold leading-6 text-gray-900">
                      How did you hear about this week?
                    </label>
                    <div className="mt-2.5">
                      <textarea name="howdoyouhear" id="howdoyouhear" rows={4} value={howdoyouhear} onChange={e => setHowdoyouhear(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" defaultValue={""} />
                    </div>
                  </div>
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      <textarea name="message" id="message" rows={4} value={message} onChange={e => setMessage(e.target.value)} className="block w-full rounded-md border-2 md:border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" defaultValue={""} />
                    </div>
                  </div>
