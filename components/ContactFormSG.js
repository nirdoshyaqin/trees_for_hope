          ...
          <form className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              {/* <div>
                    ...
                    <div className="mt-2.5">
                      <input type="text" name="company" id="company" autoComplete="family-name" value={company} placeholder="Haghighi" onChange={e => setCompany(e.target.value)} className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div> */}
