        ...
        <main className="isolate">
          ...
          <div className="bg-white px-6 pt-32 pb-16 lg:px-8">
            <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
              ...
              <p className="mt-6 text-lg leading-8">I grew up by the Caspian Sea and the Hyrcanian Forests in Northern Iran. Through the 70’s and early 80’s I traveled in Iran with my family. I reteam a joy of life that belongs to the kingdom of childhood, and a healthy land that belongs to intact ecosystems. I emigrated from Iran to Japan in 1984 with my family. We left a war-torn country to seek better opportunities for our futures.</p>
              ...
              <p className="mt-6 text-lg leading-8">Trees for Hope is connecting and growing with local communities and networks in the Fertile Crescent, such as the Ecosystem Restoration Camp. A journey towards rewilding ourselves and our ecosystems has begun. I feel I am a part of this movement. Deeper down, I feel it is life itself that is guiding me, and the network to form, to connect, to dissolve, and to heal and reveal. We are responding to the desire and the intelligence of life in its essence.</p>
