              ...
              <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                  <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                    ...
                    <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">Trees for Hope is connecting and growing with local communities and networks in the Fertile Crescent, such as the Ecosystem Restoration Camp. A journey towards rewilding ourselves and our ecosystems has begun. I feel I am a part of this movement. Deeper down, I feel it is life itself that is guiding me, and the network to form, to connect, to dissolve, and to heal and reveal. We are responding to the desire and the intelligence of life in its essence.</p>
