...
export default function handler(req, res) {  
  if(req.method === 'POST') {
    ...
    // sgMail.setApiKey("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"); //SendGridのAPIキー
    sgMail.setApiKey("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"); //SendGridのAPIキー
